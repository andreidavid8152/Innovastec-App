  ...
  export const RegistroISP = () => {
    ...
    useEffect(() => {
      // Función para cargar las marcas desde el endpoint
      ...
      const recuperarProgresoOLT = async () => {
        try {
          ...
          if (!respuesta.ok) {
            ...
            setOltActual(oltsCompletados + 1);
          }
        } catch (error) {
        }
      };
    ...
    const validarFormulario = () => {
      ...
      if (!formData.modeloOLT.trim()) {
        nuevosErrores.modeloOLT =
          "La seleccion de un modelo OLT es obligatoria.";
      }
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        if (respuesta.ok) {
          ...
          if (oltActual < oltsPermitidos) {
            setOltActual(oltActual + 1); // Prepara el formulario para el siguiente registro OLT
            setIsSubmitting(false); // Restablecer el estado de envío
            // Restablecer formulario o prepararlo para el siguiente registro
            setFormData({
              nombreOLT: "",
              marcaOLT: "",
              modeloOLT: "",
            ...
            toast.success(`OLT ${oltActual} registrado con éxito.`, {
              position: "top-right",
              autoClose: 1850,
              closeOnClick: true,
              pauseOnHover: true,
    ...
    return (
      <>
        <div className="flex items-center space-x-4 justify-center flex-grow -mt-1">
          <span className="flex items-center justify-center w-12 h-12 sm:w-20 sm:h-20 text-2xl sm:text-4xl border border-gray-50 rounded-full shrink-0 border-gray-900 text-gray-900">3</span>

          <h1 id='titulo' className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-none tracking-tight text-center">Registro ISP</h1>
        </div>

        <div className="flex justify-center items-center mt-4">
          <p className="text-dark text-center">Registrando OLT {oltActual} de {oltsPermitidos}</p>
        </div>
        ...
        <div className="flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="mt-2 space-y-6">
              ...
              <div className="space-y-2">
                <label className="block text-md font-semibold text-gray-900 mb-1 -mt-2">
                  Telnet:
                </label>
                <div className="grid grid-cols-2 gap-4 xls:ml-10 xls:mr-10 ml-2 mr-2">
                  <div>
                  ...
                  <div>
                    <div className="flex items-center bg-gray-50 border border-sky-300 text-gray-900 text-sm rounded-lg bg-sky-100 text-dark focus:outline-none">
                      <input
                        ...
                        data-type="snmp"
                        placeholder="Contraseña"
                        className="w-full p-2.5 bg-transparent rounded-l-lg focus:outline-none placeholder-gray-500 h-10"
                        onChange={handleChange}
                      />
                      <button
                        type="button"
